...
class RecyclerViewPositionHelper internal constructor(val recyclerView: RecyclerView) {
    ...
    fun findFirstVisibleItemPosition(): Int {
        val child: View? = findOneVisibleChild(0, layoutManager!!.childCount, false, true)
    ...
    fun findFirstCompletelyVisibleItemPosition(): Int {
        val child: View? = findOneVisibleChild(0, layoutManager!!.childCount, true, false)
        return if (child == null) RecyclerView.NO_POSITION else recyclerView.getChildAdapterPosition(
            child
        )
    }
    ...
    fun findLastVisibleItemPosition(): Int {
        val child: View? = findOneVisibleChild(layoutManager!!.childCount - 1, -1, false, true)
        return if (child == null) RecyclerView.NO_POSITION else recyclerView.getChildAdapterPosition(
            child
        )
    }
    ...
    fun findLastCompletelyVisibleItemPosition(): Int {
        val child: View? = findOneVisibleChild(layoutManager!!.childCount - 1, -1, true, false)
        return if (child == null) RecyclerView.NO_POSITION else recyclerView.getChildAdapterPosition(
            child
        )
    }
